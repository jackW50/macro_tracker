...
ActiveRecord::Schema.define(version: 2019_02_04_201926) do

  create_table "food_compositions", force: :cascade do |t|
  ...
  create_table "meal_compositions", force: :cascade do |t|
